...
// test cases 
 ...
 //********************************* Fix here for null 
	return testcaseService.getAllTestCases(null);
	 //********************************* Fix here for null 
    }
    ...
    public @ResponseBody
    TestCase getTestCaseAt(@PathVariable("index") Long id) {
	return testcaseService.getTestCase(id);
    }

    @RequestMapping(value = "/testcases", method = RequestMethod.POST)
    @ResponseStatus(HttpStatus.CREATED)
    public void createTestCase(@RequestBody TestCase testcase, HttpServletRequest request,
	    HttpServletResponse response) {
 //********************************* Fix here for null 
    	testcaseService.addNewTestCase(testcase,null);
 // ******************************************************   	
	response.addHeader("Location",
		getLocationForChildResource(request, testcase.getId()));
    }
 ...
 //tesplans 
    ...
    @ResponseStatus(HttpStatus.OK)
    public @ResponseBody
    TestPlan getTestPlanAt(@PathVariable("index") Long id) {
